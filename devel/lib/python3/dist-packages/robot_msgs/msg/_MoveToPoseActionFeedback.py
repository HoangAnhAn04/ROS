...
"""autogenerated by genpy from robot_msgs/MoveToPoseActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveToPoseActionFeedback(genpy.Message):
  _md5sum = "1e58c3b9cab2f3369642cde24ff744da"
  _type = "robot_msgs/MoveToPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_msgs/MoveToPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robot_msgs.msg.MoveToPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_msgs.msg.MoveToPoseFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percentage,) = _get_struct_f().unpack(str[start:end])
      return self

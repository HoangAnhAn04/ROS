...
class MoveToPoseActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MoveToPoseActionFeedback
    ...
    bufferOffset = MoveToPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MoveToPoseActionFeedback
    let len;
    let data = new MoveToPoseActionFeedback(null);
    ...
    data.feedback = MoveToPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'robot_msgs/MoveToPoseActionFeedback';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '1e58c3b9cab2f3369642cde24ff744da';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveToPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveToPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveToPoseFeedback()
    }
...
module.exports = MoveToPoseActionFeedback;
